...
export default class VideoPlayer extends Component {
    ...
    constructor( props ) {
         ...
         * Various animations
         */
        const initialValue = this.props.showOnStart ? 0 : 0;
    ...
    */
    ...
    renderTopControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../../assets/videoplayerassets/top-vignette.png' ) }
    ...
    renderBack() {
        ...
        return this.renderControl(
            <Image
                source={ require( '../../assets/videoplayerassets/back.png' ) }
    ...
    renderVolume() {
        ...
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( '../../assets/videoplayerassets/volume.png' ) } />
                </View>
            </View>
        );
    }
    ...
    renderFullscreen() {
        ...
        let source = this.state.isFullscreen === true ? require( '../../assets/videoplayerassets/shrink.png' ) : require( '../../assets/videoplayerassets/expand.png' );
        return this.renderControl(
            <Image source={ source } />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../../assets/videoplayerassets/bottom-vignette.png' ) }
                    style={[ styles.controls.column ]}
                    imageStyle={[ styles.controls.vignette ]}>
                    { seekbarControl }
                    <SafeAreaView
    ...
    renderPlayPause() {
        ...
        let source = this.state.paused === true ? require( '../../assets/videoplayerassets/play.png' ) : require( '../../assets/videoplayerassets/pause.png' );
        return this.renderControl(
            <Image source={ source } />,
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( '../../assets/videoplayerassets/loader-icon.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
                    ...
                    <Text style={styles.loader.text}>Loading Neighborhood Watch Stream</Text>
                </View>
            );
        }
        return null;
        ...
        if ( this.state.error ) {
            ...
            return (
                <View style={ styles.error.container }>
                    <Image source={ require( '../../assets/videoplayerassets/error-icon.png' ) } style={ styles.error.icon } />
    ...
    renderEnd(){
        if(this.state.ended){
            return(
                <View style={styles.ended.container}>
                    <Image source={ require( '../../assets/videoplayerassets/error-icon.png' ) } style={ styles.error.icon } />
                    <Text style={ styles.ended.text }>
                        Stream Ended
                    </Text>
                </View>
            )
